    ...
    var option = {
        ...
        series: [
            ...
            },
            {
                ...
                type: 'line',
                smooth: true,
                data: [40, 64, 191, 324, 290, 330, 310, 213, 380, 200, 180, 79]
            }
        ]
    }
    myChart.setOption(option)
        ...
        series: [
            {
                ...
                data: [30,40,30,40,30,40,30,60,20,40,30,40,30,40,30,40,30,60,20,40,30,40,30,40,20,60,50,40],
                smooth: true,
                // 单独修改当前线条样式
                lineStyle: {
                    color: '#0184d5',
                        ...
                        [
                            {
                                // 起始值（上） offset-偏移
                                offset: 0,
                                color: 'rgba(0, 261, 135, 0.4)',
                            },
                            {
                                // 结束值（下）
                                offset: 0.8,
                                color: 'rgba(0, 261, 135, 0.1)'
                            }
                        ],
                        false
                    ),
...
// 地图
(function(){
    var myChart = new echarts.init(document.querySelector('.map .chart'))
    var geoCoordMap = {
        '上海': [121.4648,31.2891],
        '东莞': [113.8953,22.901],
        '东营': [118.7073,37.5513],
